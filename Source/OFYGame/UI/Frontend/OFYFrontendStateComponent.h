...
#include "OFYFrontendStateComponent.generated.h"
...
class OFYGAME_API UOFYFrontendStateComponent : public UGameStateComponent, public ILoadingProcessInterface
{
	GENERATED_BODY()
public:
	UOFYFrontendStateComponent(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
private:
	void OnExperienceLoaded(const UOFYExperienceDefinition* Experience);
