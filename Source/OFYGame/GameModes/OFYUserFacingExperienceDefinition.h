...
#include "OFYUserFacingExperienceDefinition.generated.h"
...
class UOFYUserFacingExperienceDefinition : public UPrimaryDataAsset
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category=Experience, meta=(AllowedTypes="OFYExperienceDefinition"))
