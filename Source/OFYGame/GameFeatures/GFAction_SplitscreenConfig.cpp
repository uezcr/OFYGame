...
#include "GameFeatures/GFAction_SplitscreenConfig.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(GFAction_SplitscreenConfig)

#define LOCTEXT_NAMESPACE "OFYGameFeatures"

TMap<FObjectKey, int32> UGFAction_SplitscreenConfig::GlobalDisableVotes;

void UGFAction_SplitscreenConfig::OnGameFeatureDeactivating(FGameFeatureDeactivatingContext& Context)
{
...
void UGFAction_SplitscreenConfig::AddToWorld(const FWorldContext& WorldContext,
