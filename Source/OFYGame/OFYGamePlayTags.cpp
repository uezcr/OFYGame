...
FOFYGameplayTags FOFYGameplayTags::GameplayTags;
...
FGameplayTag FOFYGameplayTags::FindTagByString(FString TagString, bool bMatchPartialString)
{
...
void FOFYGameplayTags::AddAllTags(UGameplayTagsManager& Manager)
{
...
void FOFYGameplayTags::AddMovementModeTag(FGameplayTag& OutTag, const ANSICHAR* TagName, uint8 MovementMode)
{
	AddTag(OutTag, TagName, "Character movement mode tag.");
	GameplayTags.MovementModeTagMap.Add(MovementMode, OutTag);
}

void FOFYGameplayTags::AddCustomMovementModeTag(FGameplayTag& OutTag, const ANSICHAR* TagName, uint8 CustomMovementMode)
{
